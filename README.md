...
| **`evals/`** | 36 题真实南大校园问题评测基准题库与 6 大质量红线指标 | 🧪 [AI 问答质量评测基准 (`evals/README.md`)](evals/README.md) |
| **`scripts/`** | 一键发版同步、评测种子入库、基准回归与生产路由探针等 CLI 运维工具 | 🛠️ [运维与自动化脚本工具 (`scripts/README.md`)](scripts/README.md) |
| **`tests/`** | 174+ 项自动化单测、组件交互测试、API 集成测试与 Schema 防漂移门禁 | 🛡️ [自动化测试套件与门禁 (`tests/README.md`)](tests/README.md) |
