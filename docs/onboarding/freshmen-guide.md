...
校园卡的详细介绍在这里：[NCU校园卡简介](/docs/onboarding/campus-card) 

校园电话卡详细介绍在这里：[网络与流量卡（“校园卡”）](/docs/onboarding/network) 
...
见：[报修指南](/docs/campus-life/repair) 
...
新生选课在军训的最后一周。可以提前在[培养方案](/docs/academics/curriculum)上了解本专业所需要修的课程，大一的公共基础课基本是固定的，主要是选上课的老师。
...
不喜欢本专业，还有很多其他办法可以修读其他专业，详细请看：[不喜欢本专业/想学其他专业](/docs/academics/major-change) 
