...
- 小号潜伏新生群，复制新生QQ号，精准查找加好友/私聊
    - 校园网推销（**推销人员口中的校园卡=办理校园网络的电话卡，**具体信息请看[网络与流量卡（“校园卡”）](/docs/life/network) ）
...
5. 八月中旬
南大家园App注册【[南大家园注册流程](/docs/yellow-pages/jiayuan-register) 】
6. 8.20
空调预定结束分配宿舍
7. 8.27—8.30
...
> 更具体详细的校园相关信息平台可以在[黄页](/docs/yellow-pages/) 中查看
> 
...
- 南大家园 ｜ 你的校园生活轨迹
南大家园涵盖了学习、生活等各方面的信息，你可以在这查询宿舍电量余额、课表、成绩等信息；也可以在圈子里看到同校学子们分享日常动态、共同打卡坚持习惯哦。点击此处查看[南大家园注册流程](/docs/yellow-pages/jiayuan-register)
- 企业微信
...
下面主要介绍前湖校区的交通方式，其他校区的可以在[ 校内出行](/docs/life/campus-transport) 更详细地看到
...
校区间交通已经在[ 校内出行](/docs/life/campus-transport) 此篇有比较详细的整理了，在此就不多赘述了。
...
更详细的交通方式推荐，可以在[校外交通](/docs/life/external-transport) 查看
...
**关于每个楼栋具体的一些问题（独立卫浴、用电规则、热水使用…等），在[寝室生活](/docs/life/dorm-life) 中已经详细列出，可以跳转查看。**
...
校园卡的详细介绍在这里：[NCU校园卡简介](/docs/life/campus-card) 

校园电话卡详细介绍在这里：[网络与流量卡（“校园卡”）](/docs/life/network) 
...
其余必备物品可见：[必备物品](/docs/life/essentials) 
...
其余相关英语考试详情请看：[英语](/docs/study/english) 
...
以上名词具体详细解释请看：[学分、绩点、二课分、综测](/docs/study/credits-gpa) [辅修&第二学士学位](/docs/study/double-degree) 

## 选课&教材

### 选课

新生选课在军训的最后一周。可以提前在[培养方案](/docs/courses/curriculum)上了解本专业所需要修的课程，大一的公共基础课基本是固定的，主要是选上课的老师。
...
更详细的内容请看：[校园跑&体测](/docs/study/sports) 

## 大类分流

大一学年结束时，大类招生的专业会进行大类分流。具体的分流规则可以去查看本专业的[培养方案](/docs/courses/curriculum)。大部分是根据绩点分流，按照大一一学年的绩点，顺序志愿分流。
...
不喜欢本专业，还有很多其他办法可以修读其他专业，详细请看：[不喜欢本专业/想学其他专业](/docs/study/major-change) 
...
详细可以看：[保研](/docs/study/postgraduate) 
...
最后进入致谢环节。先~~夹带私货~~推荐一下南昌大学家园工作室。**全校唯一由学生自主管理，也是唯一和互联网有关的校级社团。**[南大家园](/docs/yellow-pages/jiayuan-register)的日常维护、官方迎新QQ群聊（1053156036）管理；同时不断推出新产品（比如本生存手册）；同时微信公众号：南昌大学家园网（会更新互联网相关知识，以及南大家园最新动态）；小红书：[小家园传声机](https://www.xiaohongshu.com/user/profile/66ea8acd000000001d021e36?xsec_token=AB51qXGNwx3ZnDcqfwzn0XsbC1LX-9ztWGmzVDyiLlJEs%3D&xsec_source=pc_search&m_source=mengfanwetab)（更新家园最新动态）。欢迎大家关注！我们致力于打造一个有温暖，有爱的校园媒体和互联网平台。
