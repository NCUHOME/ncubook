  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-[760px] animate-pulse bg-canvas px-s5 py-s6">
      ...
      <div className="mt-s6 border-b border-line pb-s5">
        <div className="h-s7 w-[180px] rounded-round bg-surface-subtle" />
        <div className="mt-s4 h-s4 w-full rounded-round bg-surface-subtle" />
        <div className="mt-s2 h-s4 w-[80%] rounded-round bg-surface-subtle" />
      </div>

      {/* 子文档导航树骨架 */}
      <div className="mt-s6 space-y-s3">
        <div className="h-s3 w-[100px] rounded-round bg-surface-subtle" />
        <div className="h-[64px] rounded-round border border-line bg-surface-subtle" />
        <div className="h-[64px] rounded-round border border-line bg-surface-subtle" />
        <div className="h-[64px] rounded-round border border-line bg-surface-subtle" />
      </div>
    </div>
